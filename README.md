...
- **⚡ 快速选量** — 滚轮选择奶量，支持 0~240ml 每 10ml 一档，记忆上次选择
- **🏷️ 喂养类型** — 母乳 / 配方奶 / 混合，可选标识，记忆上次选择
- **📋 历史记录** — 按日期分组展示，支持选择日期查看、左滑删除
- **📊 数据统计** — 选择任意日期查看连续 7 天喂养趋势，每日柱状图、喂养类型比例
- **🔄 自动同步** — 同一 WiFi 下多设备自动发现并同步数据，无需任何配置
- **🧩 桌面小组件** — 2×2 小组件，今日统计一目了然，点击打开 App 快速记录
